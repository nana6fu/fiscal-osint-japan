...
OUTPUT_JSON = "chugoku_r7_all_full.json"
...
def main():
    print("=" * 70)
    print("中国地方整備局 R7統合Excel → JSON抽出 v1")
    print("=" * 70)
    
    # 中国R7: 月別Excel 24本を一括処理
    kouji_col_map = {
        'memo': 18,
        'contract_amount': 17,
    ...
    gyoumu_col_map = {
        'memo': 22,
        'contract_amount': 21,
        'amount_1': 12, 'amount_2': 15, 'amount_3': 18,
    }
