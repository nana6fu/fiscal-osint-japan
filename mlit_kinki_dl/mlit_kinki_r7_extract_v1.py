...
OUTPUT_JSON = "kinki_r7_all_full.json"
...
def main():
    print("=" * 70)
    print("近畿地方整備局 R7統合Excel → JSON抽出 v1")
    print("=" * 70)
    
    # 近畿R7: 月別Excel 24本を一括処理
    kouji_col_map = {
        'memo': 19,
        'contract_amount': 18,
    ...
    files = sorted(Path("r7_full").glob("*.xlsx"))
    kouji = []
    gyoumu = []
