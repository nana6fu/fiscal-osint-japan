...
RAW_DIR = Path("data/mod/hokkaido/raw")
OUT_DIR = Path("data/mod/hokkaido/processed")
OUT_DIR.mkdir(parents=True, exist_ok=True)

SOURCE_FILES = [
    ("北海道本局", RAW_DIR / "hokkaido_honkyoku.html"),
    ("帯広防衛支局", RAW_DIR / "hokkaido_obihiro.html"),
    ("技術提案・交渉方式", RAW_DIR / "hokkaido_eci.html"),
]

SOURCE_URL = "https://www.mod.go.jp/rdb/hokkaido/keiyaku/"
...
(OUT_DIR / "hokkaido_all_cases.json").write_text(json.dumps(all_cases, ensure_ascii=False, indent=2))
(OUT_DIR / "hokkaido_top30.json").write_text(json.dumps(top30, ensure_ascii=False, indent=2))
(OUT_DIR / "hokkaido_company.json").write_text(json.dumps(company_list, ensure_ascii=False, indent=2))
(OUT_DIR / "hokkaido_summary.json").write_text(json.dumps(summary, ensure_ascii=False, indent=2))
