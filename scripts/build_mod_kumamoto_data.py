...
RAW_DIR = Path("data/mod/kumamoto/raw")
OUT_DIR = Path("data/mod/kumamoto/processed")
OUT_DIR.mkdir(parents=True, exist_ok=True)

FILES = [
    ("工事", RAW_DIR / "kumamoto_kouji.html"),
    ("業務", RAW_DIR / "kumamoto_gyoumu.html"),
]
    ...
    for table in tables:
        ...
        for _, r in df.iterrows():
            ...
            item = {
                ...
                "note": "",
                "bureau": "熊本防衛支局",
                "source_url": "https://www.mod.go.jp/rdb/kyushu/contract/construction/kumamoto/index.html",
                "start": start,
                "end": end
            }
...
(OUT_DIR / "kumamoto_all_cases.json").write_text(json.dumps(all_cases, ensure_ascii=False, indent=2))
(OUT_DIR / "kumamoto_top30.json").write_text(json.dumps(top30, ensure_ascii=False, indent=2))
(OUT_DIR / "kumamoto_company.json").write_text(json.dumps(company_list, ensure_ascii=False, indent=2))
(OUT_DIR / "kumamoto_summary.json").write_text(json.dumps(summary, ensure_ascii=False, indent=2))
