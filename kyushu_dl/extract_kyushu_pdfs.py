#!/usr/bin/env python3
"""
九州防衛局R7 PDF一括抽出スクリプト

北関東のextract_nkanto_pdfs_v2.pyベースで、4ソース対応に拡張:
- 工事_調達部
- 工事_管理部
- 業務_調達部
- 業務_企画部管理部
...
使い方:
    python3 extract_kyushu_pdfs.py

入力: ./kyushu_r7_pdfs/*/*.pdf
出力:
    - ./kyushu_r7_all.json
    - ./kyushu_r7_errors.txt
    - ./kyushu_r7_summary.txt
"""
import os
import re
import sys
...
def main():
    ...
    for cat_dir, kind in CATEGORIES:
        ...
        for i, fp in enumerate(files, 1):
            ...
            r['source_category'] = cat_dir  # どの部署経由かを記録
