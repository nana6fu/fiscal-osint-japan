...
OUTPUT_JSON = "kyushu_r7_all_full.json"
...
def main():
    print("=" * 70)
    print("九州地方整備局 R7統合Excel → JSON抽出 v1")
    print("=" * 70)
    
    # 九州R7: 月別Excel 24本を一括処理
    kouji_col_map = {
        'memo': 19,
        'contract_amount': 18,
        'amount_1': 12, 'amount_2': 14, 'amount_3': 16,
    }
