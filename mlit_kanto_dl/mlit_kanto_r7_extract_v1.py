...
INPUT_KOUJI = "r7_full/000947052.xls"
INPUT_GYOUMU = "r7_full/000947053.xls"
OUTPUT_JSON = "kanto_r7_all_full.json"
...
def main():
    print("=" * 70)
    print("関東地方整備局 R7統合Excel → JSON抽出 v1")
    print("=" * 70)
